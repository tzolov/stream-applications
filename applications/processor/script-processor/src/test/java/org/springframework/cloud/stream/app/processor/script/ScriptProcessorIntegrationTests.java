...
public class ScriptProcessorIntegrationTests {
	...
	public void testJavascriptFunctions() throws IOException {
		try (ConfigurableApplicationContext context = new SpringApplicationBuilder(
				TestChannelBinderConfiguration.getCompleteConfiguration(ScriptProcessorTestAppConfiguration.class))
	...
	public static class ScriptProcessorTestAppConfiguration {
	}
}
